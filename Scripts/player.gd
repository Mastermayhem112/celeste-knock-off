...
func _physics_process(delta: float) -> void:
	...
	dashDirection = Vector2(qVelX * velXmult, -qVelY * velYmult)
	...
	if is_on_floor() or tryMoveHori() != 0:
		canQ = true
